...
<div  class="main-right"  style="width:85%;height:100%;float:left;margin-top:2%;overflow-y:scroll;" >
    <el-button type="primary" @click="addaudio()">添加</el-button>
    <el-button type="primary" round>保存</el-button>
   <div >
     <div style="width:70px;height:40px;float:left;margin_right:5px;line_height:40px;text_align:'center'">book_id:</div><el-input v-model="book_id"style="width:100px;float:left;margin_right:5px;"></></el-input>
      <div style="width:70px;height:40px;float:left;margin_right:5px;line_height:40px;text_align:'center'">level:</div><el-input v-model="level"style="width:100px;float:left;margin_right:5px;"></></el-input>
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
       <el-button type="text" size="small" @click="ononline(scope.row)">上线</el-button>
        ...
        <el-button@click="muiscPlay1(scope.row.url)"  type="text" size="small">试听</el-button>
...
export default {
     ...
     .then(function(result){
      ...
      muiscPlay1(r){
        ...
        this.gamemuiscs1.play();
          ...
          A(answera1){
              this.$router.push('/answera1')
          },
           B(answerb1){
              this.$router.push('/answerb1')
          },
           C(answerc1){
              this.$router.push('/answerc1')
          },
              D(answerd1){
              this.$router.push('/answerd1')
          },
 ...
 handleClick(row) {
        console.log(row)
          ...
          obj.url = row.url;
          obj.source = 6;
         this.$router.push({name:'audioedit',params:obj})
          this.$store.dispatch('editAudio',this.$route.params )
